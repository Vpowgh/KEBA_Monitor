...
slowdata = [1014, 1016, 1018, 1036, 1100, 1110, 1500, 1550, 1552, 1600, 1602]
...
phaseswitchingsource_dict = {0:"None", 1:"OCPP", 2:"REST API", 3:"ModbusTCP", 4:"UDP"}
phaseswitchingstate_dict = {1:"1-phase", 3:"3-phase"}
...
def task():
    ...
    if regval != None:
        ...
        elif register_id == 1550:
            if regval in phaseswitchingsource_dict:
                regval = phaseswitchingsource_dict[regval]
        elif register_id == 1552:
            if regval in phaseswitchingstate_dict:
                regval = phaseswitchingstate_dict[regval]
        elif register_id == 1006:
            regval = format(regval, 'x')
        elif register_id == 1008 or register_id == 1010 or register_id == 1012 or register_id == 1100 or register_id == 1110 or register_id == 1600:
...
@app.route('/')
def server_index():
    return static_file('kebaUI.html', root = './')
